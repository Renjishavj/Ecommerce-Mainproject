          ...
          <div className="icon-div">
            ...
            {isDropdownVisible && (
              <div className="dropdown">
                <div className="dropdown-item"><button className="drop-btn-login" onClick={toggleVisiblelogin}>Login</button></div>
                <div className="dropdown-item"><button className="drop-btn-register" onClick={toggleVisibleRegister}>Register</button></div>
              </div>
            )}
          </div>
          {isLoginVisible && (
